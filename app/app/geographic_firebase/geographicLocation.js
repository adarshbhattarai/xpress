...
angular.module('myApp.geographicLocation', ['ngRoute','firebase'])

.config(['$routeProvider', function($routeProvider) {
	$routeProvider.when('/geo-map', {
    templateUrl: 'geographic_firebase/geo.html',
		controller: 'MapCtrl'
	});
}])

.controller('MapCtrl', ['$scope','$location','$firebase','LoginService', function($scope,$location,$firebase,LoginService) {

console.log("Map");


/*// Create a Firebase reference where GeoFire will store its information
var firebaseRef = new Firebase("https://x-press-yeti.firebaseio.com/geomap");
